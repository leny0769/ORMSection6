                ...
                <form action="{{ route('mangas.update',$manga->id)}}" method="POST">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control @error('nomDessinateur') is-invalid @enderror"
                            name="nomDessinateur" id="nomDessinateur" value="{{ old('nomDessinateur', $manga->nomDessinateur) }}" placeholder="Nom du dessinateur">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control @error('nomScenariste') is-invalid @enderror"
                            name="nomScenariste" id="nomScenariste" value="{{ old('nomScenariste', $manga->nomScenariste) }}" placeholder="Nom du scenariste">
                        @error('nomScenariste')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control @error('genre') is-invalid @enderror" name="genre" id="genre"
                            value="{{ old('genre', $manga->genre) }}" placeholder="Genre du Manga">
                        @error('genre')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <br>
                    <div class="form-group">
                        <input type="text" class="form-control @error('prix') is-invalid @enderror" name="prix" id="prix"
                            value="{{ old('prix', $manga->prix) }}" placeholder="Prix du Manga"> 
                    @error('prix') 
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                    </div>
